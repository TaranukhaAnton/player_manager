package ua.sigma.pm.repository;

import ua.sigma.pm.PlayerManagerApp;
import ua.sigma.pm.config.Constants;
import ua.sigma.pm.config.audit.AuditEventConverter;
...
import static ua.sigma.pm.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
