...
import static ua.sigma.pm.web.rest.TestUtil.createFormattingConversionService;
...
public class PlayerResourceIntTest {
    ...
    private static final String DEFAULT_GAME_ACCOUNT = "AAAAAAAAAA";
    private static final String UPDATED_GAME_ACCOUNT = "BBBBBBBBBB";

    private static final Instant DEFAULT_CREATION_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_CREATION_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Boolean DEFAULT_UNPLACED = false;
    private static final Boolean UPDATED_UNPLACED = true;
    ...
    public static Player createEntity(EntityManager em) {
        Player player = new Player()
            ...
            .gameAccount(DEFAULT_GAME_ACCOUNT)
            .creationDate(DEFAULT_CREATION_DATE)
            .unplaced(DEFAULT_UNPLACED);
        return player;
    }
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getMobile()).isEqualTo(DEFAULT_MOBILE);
        assertThat(testPlayer.getPhone()).isEqualTo(DEFAULT_PHONE);
        assertThat(testPlayer.getContractId()).isEqualTo(DEFAULT_CONTRACT_ID);
        assertThat(testPlayer.getGameAccount()).isEqualTo(DEFAULT_GAME_ACCOUNT);
        assertThat(testPlayer.getCreationDate()).isEqualTo(DEFAULT_CREATION_DATE);
        assertThat(testPlayer.isUnplaced()).isEqualTo(DEFAULT_UNPLACED);
    }
    ...
    public void getAllPlayers() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].gameAccount").value(hasItem(DEFAULT_GAME_ACCOUNT.toString())))
            .andExpect(jsonPath("$.[*].creationDate").value(hasItem(DEFAULT_CREATION_DATE.toString())))
            .andExpect(jsonPath("$.[*].unplaced").value(hasItem(DEFAULT_UNPLACED.booleanValue())));
    }
    ...
    public void getPlayer() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players/{id}", player.getId()))
            ...
            .andExpect(jsonPath("$.gameAccount").value(DEFAULT_GAME_ACCOUNT.toString()))
            .andExpect(jsonPath("$.creationDate").value(DEFAULT_CREATION_DATE.toString()))
            .andExpect(jsonPath("$.unplaced").value(DEFAULT_UNPLACED.booleanValue()));
    }
    @Test
    @Transactional
    ...
    public void updatePlayer() throws Exception {
        ...
        updatedPlayer
            ...
            .gameAccount(UPDATED_GAME_ACCOUNT)
            .creationDate(UPDATED_CREATION_DATE)
            .unplaced(UPDATED_UNPLACED);
        ...
        assertThat(testPlayer.getMobile()).isEqualTo(UPDATED_MOBILE);
        assertThat(testPlayer.getPhone()).isEqualTo(UPDATED_PHONE);
        assertThat(testPlayer.getContractId()).isEqualTo(UPDATED_CONTRACT_ID);
        assertThat(testPlayer.getGameAccount()).isEqualTo(UPDATED_GAME_ACCOUNT);
        assertThat(testPlayer.getCreationDate()).isEqualTo(UPDATED_CREATION_DATE);
        assertThat(testPlayer.isUnplaced()).isEqualTo(UPDATED_UNPLACED);
    }
