package ua.sigma.pm.web.rest;

import ua.sigma.pm.config.Constants;
import ua.sigma.pm.PlayerManagerApp;
import ua.sigma.pm.domain.Authority;
import ua.sigma.pm.domain.PersistentToken;
import ua.sigma.pm.domain.User;
import ua.sigma.pm.repository.AuthorityRepository;
import ua.sigma.pm.repository.PersistentTokenRepository;
import ua.sigma.pm.repository.UserRepository;
import ua.sigma.pm.security.AuthoritiesConstants;
import ua.sigma.pm.service.MailService;
import ua.sigma.pm.service.dto.UserDTO;
import ua.sigma.pm.service.dto.PasswordChangeDTO;
import ua.sigma.pm.web.rest.errors.ExceptionTranslator;
import ua.sigma.pm.web.rest.vm.KeyAndPasswordVM;
import ua.sigma.pm.web.rest.vm.ManagedUserVM;
import ua.sigma.pm.service.UserService;
...
@SpringBootTest(classes = PlayerManagerApp.class)
